    ...
    public class ApplicationContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                new Category { CategoryId = 1, Name = "Điện thoại", DisplayOrder = 1 },
                new Category { CategoryId = 2, Name = "Máy tính bảng", DisplayOrder = 2 },
                new Category { CategoryId = 3, Name = "Laptop", DisplayOrder = 3 },
                new Category { CategoryId = 4, Name = "Phụ kiện", DisplayOrder = 4 }
                );
